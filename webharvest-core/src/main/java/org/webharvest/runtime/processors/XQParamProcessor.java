...
@Definition(value = "xq-param", validAttributes = { "name", "type", "id" },
        requiredAttributes = "name",
        definitionClass = XQueryExternalParamDef.class)
public final class XQParamProcessor extends WebHarvestPlugin {
